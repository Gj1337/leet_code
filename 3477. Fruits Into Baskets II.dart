...
//     the leftmost available basket with a capacity greater
...
class SolutionTest extends Testable<int> with ConsoleTestOutput {
  ...
  final List<int> baskets;

  @override
  int computeResult() => Solution().numOfUnplacedFruits(fruits, baskets);
}

void main(List<String> args) {
  [
    SolutionTest(fruits: [4, 2, 5], baskets: [3, 5, 4], result: 1)
  ].test();
}
