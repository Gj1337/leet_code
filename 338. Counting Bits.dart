...
class SolutionTest extends Testable<List<int>> with ConsoleTestOutput {
  ...
  @override
  List<int> computeResult() => Solution().countBits(n);
}

void main(List<String> args) {
  [
    SolutionTest(n: 0, result: [0]),
    SolutionTest(n: 5, result: [0, 1, 1, 2, 1, 2]),
    SolutionTest(
        n: 15, result: [0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4])
  ].test();
}
