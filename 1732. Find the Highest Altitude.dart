...
class Solution {
  int largestAltitude(List<int> gain) {
    ...
    for (final gained in gain) {
      currentHeight += gained;
...
class SolutionTest extends Testable<int> with ConsoleTestOutput {
  ...
  @override
  int computeResult() => Solution().largestAltitude(gain);
}

void main(List<String> args) {
  [
    SolutionTest(gain: [-5, 1, 5, 0, -7], result: 1),
    SolutionTest(gain: [-4, -3, -2, -1, 4, 3, 2], result: 0)
  ].test();
}
