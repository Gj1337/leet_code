...
//    The product of the last 3 numbers is 2 * 5 * 4 = 40
// productOfNumbers.getProduct(4); // return 0.
//    The product of the last 4 numbers is 0 * 2 * 5 * 4 = 0
...
class ProductOfNumbers {
  ...
  void add(int num) => num == 0
      ? (_products
        ..clear()
        ..add(1))
      : _products.add(_products.last * num);

  int getProduct(int k) => k < _products.length
      ? _products[_products.length - 1] ~/ _products[_products.length - 1 - k]
      : 0;
}
