...
class Solution {
  int pivotIndex(List<int> nums) {
    ...
    final rightPrefixSum = List.filled(nums.length, nums.last);
...
class SolutionTest extends Testable<int> with ConsoleTestOutput {
  ...
  @override
  int computeResult() => Solution().pivotIndex(nums);
}

void main(List<String> args) {
  [
    SolutionTest(nums: [1, 7, 3, 6, 5, 6], result: 3),
    SolutionTest(nums: [1, 2, 3], result: -1),
    SolutionTest(nums: [2, 1, -1], result: 0),
  ].test();
}
