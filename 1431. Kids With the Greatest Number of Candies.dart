...
// - Kid 1, they will have 2 + 3 = 5 candies,
// which is the greatest among the kids.
// - Kid 2, they will have 3 + 3 = 6 candies,
// which is the greatest among the kids.
// - Kid 3, they will have 5 + 3 = 8 candies,
// which is the greatest among the kids.
// - Kid 4, they will have 1 + 3 = 4 candies,
...
class Solution {
  List<bool> kidsWithCandies(List<int> candies, int extraCandies) {
    final greatestNumberOfCandies = candies.reduce((a, b) => a > b ? a : b);

    return candies
        .map((candiesNumber) =>
            candiesNumber + extraCandies >= greatestNumberOfCandies)
        .toList();
  }
}

class SolutionTest extends Testable<List<bool>> with ConsoleTestOutput {
  SolutionTest({
    required this.candies,
    required this.extraCandies,
    required super.result,
  });

  final List<int> candies;
  final int extraCandies;

  @override
  computeResult() => Solution().kidsWithCandies(candies, extraCandies);
}
