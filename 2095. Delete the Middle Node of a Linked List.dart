...
class SolutionTest extends Testable<List<int>> with ConsoleTestOutput {
  ...
  List<int> computeResult() {
    ...
    final reversedHead = Solution().deleteMiddle(head);
...
void main(List<String> args) {
  [
    SolutionTest(linkedList: [1, 3, 4, 7, 1, 2, 6], result: [1, 3, 4, 1, 2, 6]),
    SolutionTest(linkedList: [1, 2, 3, 4], result: [1, 2, 4]),
    SolutionTest(linkedList: [2, 1], result: [2]),
  ].test();
}
